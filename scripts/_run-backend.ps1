$keys = @('OPEN_ROUTER_API_KEY','GROQ_API_KEY','ELEVENLABS_API_KEY','PEXELS_API_KEY','OPENAI_API_KEY','CLOUDFLARE_API_TOKEN','TURNSTILE_SECRET_KEY','METRICS_TOKEN','TRUSTED_HOSTS')
foreach ($k in $keys) {
