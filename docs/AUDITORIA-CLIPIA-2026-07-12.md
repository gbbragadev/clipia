...
| 90 dias | Problema | Após concluir localmente assets/upload/reset/consentimento/infra, DB-first e ledger `shadow`, restam o gate operacional de sete dias zero, cookie+CSRF e deploy versionado. | Segurança/operação | e6225d6, e802fd6, 63169e3, 2b94239, 3643178 e I/L. | Alta | Crítico | L | Repetir gates no candidato, obter sete dias de ledger zero e telemetria auth verde. |
