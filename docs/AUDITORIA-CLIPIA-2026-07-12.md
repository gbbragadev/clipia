...
| P2 | Problema | Após o hardening local de CORS/hosts/metrics/docs/CSP, a migração cookie/CSRF em duas releases continua pendente. | Auth e infraestrutura | 2b94239 e Auditoria técnica I. | Alta | Crítico | L | Telemetria de compatibilidade verde antes de remover Bearer/localStorage. |
...
| 90 dias | Problema | Após concluir localmente assets/upload/reset/consentimento/infra e DB-first final, restam ledger shadow, cookie+CSRF e deploy versionado. | Segurança/operação | e6225d6, e802fd6, 63169e3, 2b94239 e I/L. | Alta | Crítico | XL | Repetir threat tests no candidato, obter 7 dias de ledger zero e telemetria auth verde. |
