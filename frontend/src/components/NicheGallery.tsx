...
export function NicheGallery({ niche }: { niche: string }) {
  ...
  return (
    <div className="flex md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto overflow-x-auto md:overflow-visible snap-x snap-mandatory px-4 md:px-0 overscroll-x-contain scroll-px-4 [&>*]:w-[80vw] md:[&>*]:w-auto">
      {videos.map((item) => (
